...
Foobar2000: Convert, Downsample, Compress, Auto-Rename, De-Embed Album Art & Optimize Files
DL: https://www.foobar2000.org/download

Itunes Scrubber: Removes all your identifiable info from your iTunes files before you share them.
DL: https://app.box.com/s/do6sbcetebaqupm957n1z65filoayhco

MP3Tag: Batch Tag, Auto-tag/Rename Files, Remove ID3 Tags from FLAC Files
DL: https://www.mp3tag.de/en/download.html

Unicue: Allows you to re-encode broken cue files into UTF-8 (Used to fix CH/JP cues).
DL: https://github.com/kuyur/unicue/archive/master.zip

CueTools: Create, Edit, Repair Cues, can additionally be used to Convert & Split Files
DL: http://cue.tools/wiki/CUETools_Download
